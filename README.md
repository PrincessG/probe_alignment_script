...
To set things up on a directory on your computer from within terminal navigate to the github directory within the acanthomorph folder. Then type the following:

>git remote add upstream https://github.com/PrincessG/probe_alignment_script.git

If you haven't done so already, assign the original repository to a remote called "upstream"
>git fetch upstream
